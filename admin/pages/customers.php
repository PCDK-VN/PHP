...
<div class="bottom-insights">
    <div class="insight-card">
        <h3 class="insight-title" style="color: #ef4444;">
            <?= get_admin_icon('fire') ?> KHÁCH HÀNG TIỀM NĂNG
        </h3>
        <p class="insight-desc">Nhóm khách hàng có chi tiêu cao nhất trong tháng này. Hãy cân nhắc các chương trình tri ân.</p>
    </div>

    <div class="insight-card">
        <h3 class="insight-title" style="color: #10b981;">
            <?= get_admin_icon('dash_user') ?> KHÁCH HÀNG MỚI
        </h3>
        <p class="insight-desc">8 khách hàng mới đăng ký trong tuần qua. Tỉ lệ chuyển đổi từ khách xem hàng đạt mức cao.</p>
    </div>

    <div class="insight-card">
        <h3 class="insight-title" style="color: #6366f1;">
            <?= get_admin_icon('chart') ?> PHÂN TÍCH HÀNH VI
        </h3>
        <p class="insight-desc">94% khách hàng quay lại mua lần 2. Tỉ lệ giữ chân khách hàng đang ở mức rất ổn định.</p>
    </div>
</div>