...
<div class="bottom-insights">
    <div class="insight-card">
        <h3 class="insight-title" style="color: #3b82f6;">DANH MỤC CHỦ LỰC</h3>
        <p class="insight-desc">CPU và VGA đang chiếm 65% tổng doanh thu cửa hàng.</p>
    </div>
    <div class="insight-card">
        <h3 class="insight-title" style="color: #8b5cf6;">SẮP XẾP KHO</h3>
        <p class="insight-desc">Có 2 danh mục (Nguồn, Vỏ máy) đang có mức tồn kho thấp.</p>
    </div>
</div>