    ...
    <table class="admin-table">
        ...
        <?php else: ?>
            <?php foreach ($products as $row): ?>
                ...
                $dot_class = $row['stock'] > 0 ? 'dot-green' : 'dot-red';
                ?>
                <tr>
                    <td>
                    ...
                    <td>
                        <div class="status-indicator">
                            <span class="dot <?= $dot_class ?>"></span> <?= $row['stock'] > 0 ? 'Còn hàng' : 'Hết hàng' ?>
                        </div>
                    </td>
                    <td>
...
<div class="bottom-insights">
    <div class="insight-card">
        <h3 class="insight-title" style="color: #ef4444;"><?= get_admin_icon('fire') ?> NHU CẦU CAO</h3>
        <p class="insight-desc">Các mặt hàng sau đây đang bán nhanh hơn 30% so với trung bình.</p>
    </div>
    <div class="insight-card">
        <h3 class="insight-title" style="color: #ef4444;"><?= get_admin_icon('warning') ?> KHO Ở MỨC THẤP BÁO ĐỘNG</h3>
        <p class="insight-desc">8 mặt hàng đang dưới ngưỡng an toàn và cần được chú ý nhập hàng.</p>
    </div>
    <div class="insight-card">
        <h3 class="insight-title" style="color: #6366f1;"><?= get_admin_icon('chart') ?> PHÂN TÍCH HỆ THỐNG</h3>
        <p class="insight-desc">Sức khỏe danh mục trung bình ở mức cao.</p>
    </div>
</div>