    ...
    <form action="modules/products/add.php" method="POST" enctype="multipart/form-data">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
            ...
            <div>
                ...
                <div class="filter-group" style="margin-bottom: 16px;">
                    <label style="font-weight: 600; font-size: 13px; margin-bottom: 8px; display: block;">ẢNH ĐẠI DIỆN *</label>
                    <input type="file" name="thumbnail" accept="image/*" class="form-select" style="width: 100%; padding: 6px;" required>
                </div>
