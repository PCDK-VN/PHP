...
<div class="top-controls">
    <div class="filter-card">
        ...
        <div class="filter-badges">
            <span class="badge badge-status-pending">Chờ XL</span>
...
<div class="bottom-insights">
    <div class="insight-card">
        <h3 class="insight-title" style="color: #ef4444;">
            <?= get_admin_icon('fire') ?> ĐƠN HÀNG CẦN XỬ LÝ GẤP
        </h3>
        <p class="insight-desc">2 đơn hàng chờ xử lý lâu hơn 24 giờ. Hãy liên hệ khách hàng ngay.</p>
        <div class="insight-list">
            <div class="insight-item"><span>#OD-00003 - Nguyễn Văn A</span> <strong>28h</strong></div>
            <div class="insight-item"><span>#OD-00006 - Phạm Văn C</span> <strong>25h</strong></div>
        </div>
    </div>

    <div class="insight-card">
        <h3 class="insight-title" style="color: #ef4444;">
            <?= get_admin_icon('warning') ?> CẢNH BÁO ĐƠN HỦY/HOÀN
        </h3>
        <p class="insight-desc">5 đơn hàng bị hủy trong 7 ngày qua. Kiểm tra lý do và tối ưu quy trình.</p>
        <button class="btn btn-primary" style="width: 100%; justify-content: center; margin-top: 12px;">
            XEM BÁO CÁO HỦY/HOÀN
        </button>
    </div>

    <div class="insight-card">
        <h3 class="insight-title" style="color: #6366f1;">
            <?= get_admin_icon('chart') ?> TỔNG QUAN HIỆU SUẤT
        </h3>
        <p class="insight-desc">Tỷ lệ hoàn thành đơn hàng 85%. Số đơn hàng mới tăng 10% so với tuần trước.</p>
    </div>
</div>